...
const Nav = () => {
  return (
    <>
      <nav className="sticky w-full top-0 h-12 bg-slate-100 dark:bg-slate-950 shadow-[0_0_9px_3px_rgba(41,41,41,0.25)] z-10 py-0 px-12 flex items-center justify-around">
        <MenuMobile />
