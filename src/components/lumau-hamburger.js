...
export class LumauHamburger extends LitElement {
  ...
  static get styles() {
    return css`
      ...
      .hamburger {
        padding: var(--dile-hamburger-padding-y, 15px)
          var(--dile-hamburger-padding-x, 15px);
        display: flex;
        align-items: center;
        cursor: pointer;
...
customElements.define('lumau-hamburger', LumauHamburger);
